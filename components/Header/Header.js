...
import Click from '../../assets/audio/click-with-big-reverb.mp3'
...
export default function Header({
  ...
  return (
    ...
    <header id="masthead" className={cx('site-header', headerPresets, 'component', gridContainer, hasInlineToggle)}>
      <SkipNavigationLink />
      <div className={`${cx('inside-header', innerGridContainer)} inside-header`}>
    ...
    <div className={`${styles.menuWrapper} menu-outer`} >
